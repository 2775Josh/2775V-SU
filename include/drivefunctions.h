...
void turn(float angle, float timeout = 0, float settlingerror = 1, float settlingtime = 20, float kp = 1, float ki = .00, float kd = 3, float maxvoltage = 12);

void turntopoint(float x, float y, float timeout = 0, float settlingerror = 1, float settlingtime = 100, float kp = 1, float ki = .00, float kd = 3, float maxvoltage = 12);

void straightdrive(float x, float y, float timeout = 0, float kp = 2, float ki = 0, float kd = 10, float turnp = 1, float turni = 0, float turnd = 3, float maxvoltage = 8, float turnmaxvoltage = 12, float settlingerror = 1.5, float settlingtime = 20);
