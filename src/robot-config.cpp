...
digital_out Endgame1 = digital_out(Brain.ThreeWirePort.E);
digital_out Endgame2 = digital_out(Brain.ThreeWirePort.E);
digital_out Endgame3 = digital_out(Brain.ThreeWirePort.E);
digital_out Endgame4 = digital_out(Brain.ThreeWirePort.E);
